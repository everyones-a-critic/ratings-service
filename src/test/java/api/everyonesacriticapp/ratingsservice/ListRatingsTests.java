...
public class ListRatingsTests {
	...
	public static Rating createRating(Integer number) {
		return new Rating(
			"test-rating-" + String.valueOf(number), "633dcc5180a00f92bf00826c", "sample-user", 3.33, null, 
	...
	public void testListRatings() throws Exception {
		...
		Mockito.when(mongoMock.findAllByUserIdAndProductId("633dcc5180a00f92bf00826c", "bdbef64e-90da-4c9f-b497-3a26e8ce1073")).thenReturn(ratings);
